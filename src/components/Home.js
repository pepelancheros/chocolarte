...
class Home extends React.Component {
    ...
    componentDidMount() {
        window.addEventListener('scroll', _.throttle(this.handleScroll, 800))
    }
        ...
        return (
            <div className="home container-fluid">
                ...
                <div className="chocolate-melt">
                    <svg ref={this.myRef} className="chocolate-melt__background" viewBox="0 0 1440 1493" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
